    ...
    def generate_results(log2_db_sizes, elem_sizes):
        ...
        for log2_db_size in log2_db_sizes:
            for elem_size in elem_sizes:
                ...
                results["re"] = cal_pirac_tput(log2_db_size, elem_size, num_iter=10, rekeying=False)
                results["pirac"] = cal_pirac_tput(log2_db_size, elem_size, num_iter=10, rekeying=True)
