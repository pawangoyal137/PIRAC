...
if __name__ == "__main__":
    ...
    if pirac_mode is None:
        ...
        throughputs_combined = utils.cal_tput_with_pirac(throughputs_sealpir, throughputs_re)
        ...
        throughputs_combined = utils.cal_tput_with_pirac(throughputs_sealpir, throughputs_pirac)
        pretty_print(throughputs_combined, pirac_mode)
    else:
